...
def write_data():
    ...
    action = [1,[chatText,'storyboards/storyboard1/images/chat images/prosper.png']]
    ...
    action = [1,[chatText,'storyboards/storyboard1/images/chat images/drought.png']]
    actionData = ['action',action]
    pickle.dump(actionData,output)
    ...
    action = [1,[chatText,'storyboards/storyboard1/images/chat images/Happy.png']]
    actionData = ['actionTrue',action]
    pickle.dump(actionData,output)
    ...
    action = [1,[chatText,'storyboards/storyboard1/images/chat images/earthquake_st.png']]
    actionData = ['action',action]
    pickle.dump(actionData,output)
